...
room_great_hall = {
    ...
    "description":
    """You are now standing at the entrance of the great hall. As you look around the notice that it is lit by thousands and thousands of candles which are floating in mid-air, as you look upward you see a velvety black ceiling dotted with stars, it looks as though the great hall was the gate way to heaven. 
To your West there is a doorway with a staircase leading down, to your East there is a door and to the North there is another door, but it is locked.""",
...
room_throne_room = {
    ...
    "description":
    """As you enter the Throne Room in front of you is a large stone table with numerous symbols etched into the side of it. Laying motionless on the table was a beautiful golden coloured Lion, as you move closer to the table you see a sword protruding from the belly of this magnificent beast. In the corner of the room there is a rather large and familiar wardrobe, the wardrobe is slightly open and inside you can see at least 10 big fur coats. """,
